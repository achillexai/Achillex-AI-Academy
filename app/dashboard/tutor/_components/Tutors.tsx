          ...
          >
            {isPlanLimited && (
              <div className="absolute -top-2 -right-2 z-10">
                <Badge
                  variant="secondary"
                  className="bg-gradient-to-br from-cyan-500 via-cyan-700 to-zinc-900 text-white hover:text-white hover:border-white hover:border whitespace-nowrap text-[10px] sm:text-xs px-1 sm:px-2"
                >
